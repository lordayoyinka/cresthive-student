  ...
  return (
    <div className="flex bg-blue-50 relative flex-col h-screen overflow-y-auto">
      <div ref={scrollContainerRef} className="overflow-y-auto h-[70vh] pb-20 rounded-t-xl bg-indigo-50 m-4 p-4 flex flex-col gap-4">
        {/* Conversation Header */}
        <div className="flex flex-col justify-center items-center bg-[#DDF1DF] rounded-xl p-4">
          <h2 className="font-bold text-2xl">
            Start a conversation with the school
          </h2>
          <h4 className="font-semibold text-lg">Always active</h4>
        </div>

        {/* Conversation Messages */}
        <div className="mx-2 min-h-[40vh]  pb-[70vh] relative">
